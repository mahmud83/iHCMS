...
class WUserController extends Controller
{
	...
	public function actionView($id)
	{
		...
		$this->sub_title = 'Detail Data Wuser';
	...
	{
		$this->breadcrumbs = array('WUser'=>'', 'list');
		$this->sub_title = 'Manajemen Data Wuser';
		
		$model=new WUser('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['WUser']))
			$model->attributes=$_GET['WUser'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='wuser-form')
		{
