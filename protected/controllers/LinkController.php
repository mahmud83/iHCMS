...
class LinkController extends Controller
{
	...
	{
		$this->breadcrumbs = array('Link'=>'', 'Link');
		$this->sub_title = 'Detail Data Link';
	...
	{
		$this->breadcrumbs = array('Link'=>'', 'Link');
		$this->sub_title = 'Tambah Data Link';
	...
	{
		$this->breadcrumbs = array('Link'=>'', 'list');
		$this->sub_title = 'Daftar Data Link';
	...
	{
		$this->breadcrumbs = array('Link'=>'', 'list');
		$this->sub_title = 'Manajemen Data Link';
