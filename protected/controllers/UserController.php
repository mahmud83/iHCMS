...
class UserController extends Controller
{
	...
	{
		$this->breadcrumbs = array('User'=>'', 'User');
		$this->sub_title = 'Detail Data User';
	...
	{
		$this->breadcrumbs = array('User'=>'', 'User');
		$this->sub_title = 'Tambah Data User';
		...
		if(isset($_POST['User']))
		{
			...
			$model->tgl_buat = date('Y-m-d H:i:s');
			$model->tgl_edit = date('Y-m-d H:i:s');
	...
	{
		$this->breadcrumbs = array('User'=>'', 'list');
		$this->sub_title = 'Daftar Data User';
	...
	{
		$this->breadcrumbs = array('User'=>'', 'list');
		$this->sub_title = 'Manajemen Data User';
