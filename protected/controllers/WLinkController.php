...
class WLinkController extends Controller {
    ...
    public function actionAjaxLink() {
        $data = WLink::model()->findAll(array(
            'condition'=>'w_module_id=:module AND parent_id IS NULL',
            'params' =>array(':module' => $_POST['WLink']['w_module_id'])
        ));

        $data = CHtml::listData($data, 'id', 'title');
            echo CHTML::tag('option', array('value'=>NULL), CHtml::encode('silahkan pilih salah satu'));
