	...
	<div class="span12 widget">
		...
		<div class="widget-content">
			...
			<form class="form-horizontal">
				...
				<?php echo $form->textFieldRow($model, 'iso3', array('hint'=>'In addition to freeform text, any HTML5 text-based input appears like so.')); ?>
				<?php echo $form->textFieldRow($model, 'numcode', array('hint'=>'In addition to freeform text, any HTML5 text-based input appears like so.')); ?>
