...
class Karyawan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nip, nama_depan, warga_negara', 'required'),
			array('status_karyawan', 'numerical', 'integerOnly'=>true),
			array('nip, nama_depan, nama_tengah, nama_belakang, nama_panggilan, kelamin, status_kawin', 'length', 'max'=>45),
			array('warga_negara, kota, negara, propinsi, kodepos', 'length', 'max'=>100),
			...
			array('id, nip, nama_depan, nama_tengah, nama_belakang, nama_panggilan, tgl_lahir, warga_negara, kelamin, no_ktp, no_ktp_exp_date, no_sim, no_sim_exp_date, status_kawin, status_karyawan, alamat1, alamat2, kota, negara, propinsi, kodepos, tlp_rumah, tlp_mobile, tlp_kantor, email1, email2, custom', 'safe', 'on'=>'search'),
		);
	}
