...
Yii::import('ext.battleship.widgets.DataColumn');
...
class GridView extends CGridView {
     ...
     */
    public $pager = array('class' => 'ext.battleship.widgets.Pager');
    ...
    protected function initColumns() {
        foreach ($this->columns as $i => $column) {
            if (is_array($column) && !isset($column['class']))
                $this->columns[$i]['class'] = 'ext.battleship.widgets.DataColumn';
        }
