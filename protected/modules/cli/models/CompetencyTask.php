...
class CompetencyTask extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('w_occupation_id, competency_library_id', 'required'),
			array('w_occupation_id, competency_library_id, rcl, itj', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('w_occupation_id, competency_library_id, rcl, itj', 'safe', 'on'=>'search'),
		);
	}
