 ...
 * @property integer $competency_task_id
 * @property integer $competency_id
 *
 * The followings are the available model relations:
 * @property CompetencyTask $competencyTask
...
class CompetencyResult extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('assessor_id, assessed_id, competency_task_id, competency_id', 'required'),
			array('assessor_id, assessed_id, level, competency_task_id, competency_id', 'numerical', 'integerOnly'=>true),
			array('evidence, created, modified', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, assessor_id, assessed_id, level, evidence, created, modified, competency_task_id, competency_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'competencyTask' => array(self::BELONGS_TO, 'CompetencyTask', 'competency_task_id'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'created' => 'Created',
			'modified' => 'Modified',
			'competency_task_id' => 'Competency Task',
	...
	public function search()
	{
		...
		$criteria->compare('competency_task_id',$this->competency_task_id);
