<div class="page-header">
    ...
    <h1 id="main-heading">
        Generator Penilai Soft Competency<span>halaman untuk menggenerasi penilai per karyawan</span>
    </h1>
</div>
<div class="row-fluid">
...
<script type="text/javascript">
    $(function() {
        ...
        $("#submitPeers").live("click", function() {
            ...
            $.ajax({
                url: "<?php echo Yii::app()->createUrl('cli/suggest/AjaxSubmitSoftPeers'); ?>",
                type: "POST",
                cache: false,
                data: input,
        ...
        function ajaxLoad() {
            $.ajax({
                url: "<?php echo Yii::app()->createUrl('cli/suggest/ajaxSoftPeers'); ?>",
                type: "POST",
                cache: false,
