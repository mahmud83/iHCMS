<div class="page-header">
    ...
    <h1 id="main-heading">
        Pengukuran Kompetensi Bisnis tahun 2013<span>pengukuran kompetensi berdasar tahun pengukuran</span>
    </h1>
</div>
                            ...
                            <fieldset title="<?php echo $row->code . ' : ' . $row->name; ?>" step="<?php echo $row->id; ?>">
                                ...
                                if (count($data) > 0):
                                    ...
                                    <div class="control-group">
                                        <blockquote>
                                            <p><?php echo strip_tags($data->evidence); ?></p>
                                            <small>Evidence ditulis : <cite title="Source Title"><?php echo $data->created; ?></cite></small>
                                        </blockquote>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Leveling</label>
                                        <div class="controls">
                                            <?php
                                            for ($i = 1; $i <= 5; $i++):
                                                echo '<label class="radio">';
                                                echo '<input type="radio" class="required uniform" name="soft[level][' . $row->id . ']" value="' . $i . '" /> Level ' . $i . '';
                                                echo '</label>';
                                            endfor;
                                            ?>
                                        </div>
