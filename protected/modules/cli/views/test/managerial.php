<div class="page-header">
    ...
    <h1 id="main-heading">
        Pengukuran Individu Manajerial <span>tahun <?php echo $cli->year; ?> Jabatan <?php echo $jabatan->nama; ?></span>
    </h1>
</div>
    ...
    <div class="span12" id="request">
        <div class="row-fluid">
            <div class="span12 widget">
                <div class="widget-header"><span class="title">Kompetensi Manajerial</span></div>
                    ...
                    <form id="wizard_soft" class="form-horizontal form-step-soft" >
                        ...
                        <fieldset title="Penutup">
                            ...
                            <div class="form-actions">
                                <a class="btn btn-primary" href="<?php echo Yii::app()->createUrl('cli/test/manajerialnext'); ?>">Menuju Tahap Selanjutnya</a>
                            </div>
                        </fieldset>
                    </form>
                </div>
        ...
        $(softContainer.find('a.next')).click(function() {
            ...
            if (($('fieldset.active').find('input[type="radio"]:checked').length == 0) || (!$.trim(textarea.val()))) {
                ...
                if ((textarea.serialize() != '') || (radio.serialize() != '')) {
                    $.ajax({
                        url: "<?php echo Yii::app()->createUrl('cli/test/ajaxManagerial'); ?>",
                        type: "post",
                        cache: false,
