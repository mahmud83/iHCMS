...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2013 at 04:44 AM
...
CREATE TABLE IF NOT EXISTS `competency_rekap` (
  ...
  KEY `fk_competency_rekap_competency_library1_idx` (`competency_library_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `competency_task` (
  ...
  KEY `fk_competency_task_competency_library1_idx` (`competency_library_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `w_preference` (
  ...
  `value` text NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_w_preference_w_module1_idx` (`id_module`)
...
ALTER TABLE `competency_category`
  ADD CONSTRAINT `fk_competency_category_competency_type1` FOREIGN KEY (`competency_type_id`) REFERENCES `competency_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `competency_library`
  ADD CONSTRAINT `fk_competency_library_competency_category1` FOREIGN KEY (`category`) REFERENCES `competency_category` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `competency_rekap`
--
ALTER TABLE `competency_rekap`
  ADD CONSTRAINT `fk_competency_rekap_competency_library1` FOREIGN KEY (`competency_library_id`) REFERENCES `competency_library` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_competency_rekap_p_person1` FOREIGN KEY (`p_person_id`) REFERENCES `p_person` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_competency_rekap_w_occupation1` FOREIGN KEY (`w_occupation_id`) REFERENCES `w_occupation` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `competency_result`
--
ALTER TABLE `competency_result`
  ADD CONSTRAINT `fk_competency_result_competency_library1` FOREIGN KEY (`competency_library_id`) REFERENCES `competency_library` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `competency_task`
  ADD CONSTRAINT `fk_competency_task_competency_library1` FOREIGN KEY (`competency_library_id`) REFERENCES `competency_library` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `w_link`
  ADD CONSTRAINT `fk_link_link1` FOREIGN KEY (`parent_id`) REFERENCES `w_link` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_w_link_w_module1` FOREIGN KEY (`w_module_id`) REFERENCES `w_module` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `w_preference`
--
ALTER TABLE `w_preference`
  ADD CONSTRAINT `fk_w_preference_w_module1` FOREIGN KEY (`id_module`) REFERENCES `w_module` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
